...
import { PRIORITY_COLORS } from './helpers/flagPriorityColors';
...
function createDOMTaskElement(title, description, priorityIndex, id) {
  return `<div id='${id}' class='row my-3 align-items-center'>
      ...
      <div class="col-auto task-priority">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="${PRIORITY_COLORS[priorityIndex]}" class="bi bi-flag" viewBox="0 0 16 16">
